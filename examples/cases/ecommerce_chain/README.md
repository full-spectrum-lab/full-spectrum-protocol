...
> Single source of truth: the JSON artifacts and report in this directory are
> generated by the `full-spectrum-engine` governance-chain CLI. Do not edit
> them by hand. Use `tools/sync_engine_generated_examples.py`; CI regenerates
> the chain and compares every byte.
